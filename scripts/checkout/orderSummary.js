// 13:05:30 - fucks he talking about
...
export function renderOrderSummary() {
    ...
    cart.cartItems.forEach(async (cartItem) => {
        ...
        // const matchingProduct = loadProducts(() => {getProduct(productId)}) 
                ...
                <div class="cart-item-details-grid">
                  ...
                  <div class="cart-item-details">
                    ...
                    <div class="product-quantity js-product-quantity-${matchingProduct.id}">
                      ...
                      js-update-quantity-link link-primary" data-product-id=${matchingProduct.id}>
                        Update
                      </span>
      ...
      link.addEventListener('click', () => {
        ...
        if (newQuantity > 0 && newQuantity <= 1000) {
          ...
          const timeoutId1 = setTimeout(() => {
            document.body.innerHTML = `<p style="font-size: 500px">fuck off</p>`
          }, 2000)
          
          // i wanted to add some woowoo lines but idc anymore shit doesnt work 
        }
